 ...
 * Loop Cuentas 2016
 *
 * @package WPBilbao\Loops\Cuentas2016
...
/** Loop Cuentas 2016 - Gastos **/
function wpbilbao_loop_cuentas_2016() {
    ...
    <div class="gastos col-xs-12 col-sm-6">
      ...
      <div class="table-responsive">
        <table class="table">
          ...
          <tr>
            <td colspan="2" class="text-right"><strong><?php _e('TOTAL', 'wpbilbao'); ?>:</strong></td>
            <td class="precio"><strong><?php echo $totalGastos - 86.31 . ' €'; ?></strong></td>
          </tr>
          <tr><td class="note" colspan="3">La Cuenta Negativa 2015 no se suma al total de gastos anual.</td></tr>
          </tbody>
        </table>
  ...
  <div id="total-cuentas" class="text-center">
    ...
    if ($cuentasTotal < 0) : ?>
      <h2><?php _e('Total en Caja', 'wpbilbao'); ?>: <span class="text-danger"><?php echo $cuentasTotal ?> €</span></h2>
    <?php else : ?>
      <h2><?php _e('Total en Caja', 'wpbilbao'); ?>: <span class="text-success"><?php echo $cuentasTotal ?> €</span></h2>
    <?php endif; ?>
  </div><!-- #total-cuentas -->
